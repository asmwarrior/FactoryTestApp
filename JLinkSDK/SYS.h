...
U32               SYS_REG_SetValue                (SYS_REG_HKEY hKey, const char* sRegKey, U32 Type, const void* pData, U32 NumBytes);
U32               SYS_REG_GetValue                (SYS_REG_HKEY hKey, const char* sRegKey, U32* pType, void* pData, U32* pNumBytes);
