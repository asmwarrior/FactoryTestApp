...
//                jlink.downloadFile("sequences/OLCZhagaSTD/dummy_btl_efr32xg12.s37", 0);
//                jlink.downloadFile("sequences/OLCZhagaSTD/olc_zhaga_2l4l_railtest.hex", 0);
//                jlink.reset();
//                jlink.go();
                jlink.close();
            }
...
//                jlink.downloadFile("sequences/OLCZhagaSTD/olc_zhaga_software.hex", 0);
                jlink.close();
            }
        }
        ...
        for(var slot = 1; slot < testClient.dutsCount() + 1; slot++)
        {
            if(testClient.isDutAvailable(slot) && testClient.isDutChecked(slot))
            {
                if( testClient.getDutProperty(slot, "id") !== "" &&
                    ...
                    //testClient.getDutProperty(slot, "gnssChecked") &&
...
methodManager.addFunctionToGeneralList("Download Railtest", ZhagaSTD.downloadRailtest, true);
...
methodManager.addFunctionToGeneralList("Download software", ZhagaSTD.downloadSoftware, true);
